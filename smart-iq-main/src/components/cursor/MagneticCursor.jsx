...
/**
 * Ultra-premium custom cursor with particle trail
 * ──────────────────────────────────────────────
 * - Inner dot snaps to cursor instantly
 * - Outer ring follows with smooth lerp (lag)
 * - Particle trail system behind cursor movement
...
export default function MagneticCursor() {
  ...
  return (
    <>
      ...
      {/* Outer ring — lerp follows with lag */}
      <div
        ref={ringRef}
        style={{
          ...base,
